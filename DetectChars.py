...
from numberplate import Main, Preprocess
from numberplate.PossibleChar import PossibleChar
...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("C:\\Users\\ayane\\PycharmProjects\\NumbePlateRecongnization1\\numberplate\\classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt("C:\\Users\\ayane\\PycharmProjects\\NumbePlateRecongnization1\\numberplate\\flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
